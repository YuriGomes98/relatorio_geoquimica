...
For this analysis, we have two target elements: Copper (Cu), Gold (Au), Molybdenium (Mo), and Silver (Ag). So we need to filter the dataset prior to leave only the necessary information. 
